...
class OwCommandResponderBase:
    ...
    def sendVarBinds(
        ...
        requestId = v2c.apiPDU.getRequestID(PDU)
...
class GetOwCommandResponder(OwCommandResponderBase):
...
class NextOwCommandResponder(OwCommandResponderBase):
...
class BulkOwCommandResponder(OwCommandResponderBase):
...
class SetOwCommandResponder(OwCommandResponderBase):
